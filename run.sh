...
echo "==> Launching..."
"$JAVA" --module-path "$JFX_LIB" --add-modules javafx.controls,javafx.graphics,javafx.base,javafx.swing --enable-native-access=javafx.graphics -cp "$OUT" com.bmi.view.BmiApplication
